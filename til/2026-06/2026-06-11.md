# 2026-06-11 심화 알고리즘 — 그래프 탐색 DFS 패턴 4종
...
- [오늘 한 일 요약](#오늘-한-일-요약)
- [1. DFS/BFS 기본 템플릿](#1-dfsbfs-기본-템플릿)
- [2. int 반환 DFS — 컴포넌트 크기 추출](#2-int-반환-dfs--컴포넌트-크기-추출)
- [3. 단방향 vs 양방향 구분법](#3-단방향-vs-양방향-구분법)
- [4. bool + int& 참조 DFS — 경로 깊이 추출 (2644)](#4-bool--int-참조-dfs--경로-깊이-추출-2644)
