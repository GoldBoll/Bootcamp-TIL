...
image: /assets/img/thumbs/cards/2026-04-14-kata-codekata-14.svg
...
> **핵심 요약** — `min_element`는 최솟값의 위치(반복자)를 돌려주므로, 값을 다시 찾을 필요 없이 `erase`에 바로 넘겨 한 줄로 제거할 수 있다. 원소를 골라 새 벡터에 담는 방식보다 코드가 짧아진다.
{: .prompt-tip }
