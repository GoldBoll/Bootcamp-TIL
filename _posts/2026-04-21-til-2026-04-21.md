...
description: "CS 면접 준비 자료를 graphify 파이프라인으로 지식 그래프화 — 문제의식부터 연결 구조 발견, Claude Code 연동까지 구축 과정을 정리했다."
...
> **면접에서 이렇게 말한다** — 예상 질문: "virtual 소멸자는 왜 필요한가요?" → vtable, 다형성, 동적 디스패치, RTTI, Undefined Behavior
{: .prompt-info }
