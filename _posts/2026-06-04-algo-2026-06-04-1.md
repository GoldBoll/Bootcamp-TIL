...
image: /assets/img/thumbs/cards/2026-06-04-algo-2026-06-04-1.svg
---
...
> **핵심 요약** — (i, j)에는 위 또는 왼쪽에서만 올 수 있으므로 `grid[i][j] += min(위, 왼쪽)` 점화식으로 풀리고, 입력 격자를 dp 테이블로 덮어쓰면 추가 공간 없이 O(1)로 처리된다.
{: .prompt-tip }
