...
image: /assets/img/thumbs/cards/2026-03-04-kata-codekata-07.svg
---
...
> **핵심 요약** — 문자열을 pos 포인터로 왼쪽부터 소비하며 토큰을 매칭하는 패턴을 익혔다. `pos == word.size()`까지 도달했는지가 성공 판정 기준이고, used 배열이 토큰별 사용 횟수 제한을 담당한다.
{: .prompt-tip }
