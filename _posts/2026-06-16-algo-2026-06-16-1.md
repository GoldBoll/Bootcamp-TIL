...
image: /assets/img/thumbs/cards/2026-06-16-algo-2026-06-16-1.svg
---
...
> **핵심 요약** — "두 집합으로 같게 나눈다"는 "전체 합의 절반을 만드는 부분집합이 있는가"로 환원된다. 홀수 합은 즉시 false로 거르고, 1차원 DP를 역순으로 순회해야 각 원소를 한 번만 쓰는 0/1 제약이 지켜진다.
{: .prompt-tip }
