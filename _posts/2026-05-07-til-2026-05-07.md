...
> **면접에서 이렇게 말한다** — 예상 질문: "UE5 모듈에서 Public/Private 폴더를 나누는 이유와 include 경로 규칙을 설명해 주세요" → UBT 자동 include path, Public 루트만 등록, 카테고리 풀 경로, bLegacyPublicIncludePaths, API 경계
{: .prompt-info }
