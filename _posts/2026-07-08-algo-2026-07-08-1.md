...
image: /assets/img/thumbs/cards/2026-07-08-algo-2026-07-08-1.svg
---
...
> **핵심 요약** — "가능한 조합의 개수만 묻고 조합 자체는 안 묻는" 문제는 나열(최악 2^30)이 아니라 곱의 법칙(O(n))으로 센다. "안 입는다"를 선택지에 넣는 +1 트릭으로 "최소 1개는 입는다" 조건이 공집합 1가지 빼기로 수식 안에 흡수된다.
{: .prompt-tip }
