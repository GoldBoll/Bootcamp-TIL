---
title: "2~4인 협동 이사 게임 기획과 운반 시스템"
...
> **핵심 요약** — 기획안을 구현 관점으로 다시 읽으면, "여럿이 동시에 든다"는 재미 요소가 곧 서버 권위 + Replication 설계 문제라는 게 보인다. 속도 페널티 공식처럼 수식은 있는데 단위·하한이 비어 있는 지점은 구현 전에 팀과 맞춰야 할 확인 목록이 된다.
{: .prompt-tip }
