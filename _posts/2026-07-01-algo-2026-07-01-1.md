...
image: /assets/img/thumbs/cards/2026-07-01-algo-2026-07-01-1.svg
---
...
> **핵심 요약** — n이 최대 1,000이면 부분 수열 n²개를 전부 도는 완전탐색으로 충분하다. 최적화 기법을 찾기 전에 제약으로 탐색 공간부터 계산하는 순서를 익혔고, 원형 수열은 인덱스를 `% n`으로 감으면 배열 복사 없이 처리된다는 것도 확인했다.
{: .prompt-tip }
