...
![팀 소개](images/image.png)

![레퍼런스 — Shattered Pixel Dungeon](images/image%201.png)
...
![게임 플로우차트](images/image%202.png)

## 게임 루프와 입력

GameManager가 입력→행동→렌더 순서의 게임 루프를 총괄하고, InputManager는 키 입력을 GameAction으로 추상화해서 넘긴다.

![핵심 멤버 구조](images/image%203.png)

![게임 루프 흐름](images/image%204.png)

![게임 실행 화면 전체](images/image%205.png)
...
![기본 배경 UI](images/image%206.png)

![UI 예시 1](images/image%207.png)

![UI 예시 2](images/image%208.png)

![전체 UI 레이아웃 화면](images/image%209.png)

![RenderInfo HP바](images/image%2010.png)

## 아이템 시스템

![아이템 시스템](images/image%2011.png)
...
![인벤토리 UI 화면](images/image%2012.png)

![아이템 획득 → 인벤토리 → 사용 흐름](images/image%2013.png)
...
![스폰 결과 화면](images/image%2014.png)
...
![몬스터 랜덤 이동 화면](images/%EC%A0%9C%EB%AA%A9_%EC%97%86%EC%9D%8C.gif)
