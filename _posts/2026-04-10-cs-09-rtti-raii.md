...
image: /assets/img/thumbs/cards/2026-04-10-cs-09-rtti-raii.svg
...
> **핵심 요약** — RTTI와 RAII는 결국 vtable에서 만난다. `typeid`/`dynamic_cast`는 vtable 헤더의 `type_info*`를 읽고, RAII를 다형 클래스에 쓰려면 virtual 소멸자(= vtable)가 필수라서, 어떤 꼬리질문이 와도 vtable로 답변을 이어갈 수 있다.
{: .prompt-tip }
