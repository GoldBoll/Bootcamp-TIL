...
image: /assets/img/thumbs/cards/2026-07-20-algo-leetcode-997-town-judge.svg
---
...
- **간선 목록이 주어졌다고 탐색 문제인 건 아니다.** 그래프 탐색 문제(1971 BFS, 547 DFS)를 풀고 나면 `trust[i] = {a, b}`만 봐도 손이 인접 리스트로 가는데, 조건이 "그 정점 하나만 보면 판정되는" 형태(차수·개수)로 번역되면 탐색은 증발한다. 자료구조를 꺼내기 전에 조건을 그래프 용어로 옮겨 보는 게 먼저다.
