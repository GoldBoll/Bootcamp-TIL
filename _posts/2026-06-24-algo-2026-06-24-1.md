...
image: /assets/img/thumbs/cards/2026-06-24-algo-2026-06-24-1.svg
---
...
> **핵심 요약** — 새 문자열을 만들지 않고 양끝 투 포인터로 건너뛰며 비교하면 공간이 O(1)로 떨어진다. `isalnum`/`tolower`에는 `unsigned char` 캐스팅, 안쪽 while에도 `l < r` 가드를 두는 것이 경계 처리의 핵심이다.
{: .prompt-tip }
