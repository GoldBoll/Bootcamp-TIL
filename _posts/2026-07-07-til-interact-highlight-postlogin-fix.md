---
title: "인터랙션 하이라이트 링 구현"
subtitle: "패스를 늘리지 않고 아웃라인 위에 얹기"
date: 2026-07-07 21:30:00 +0900
categories: ["언리얼", "쿠펭"]
tags: ["ue5", "cpp", "material", "gamemode", "multiplayer", "debugging", "트러블슈팅"]
...
- 지금 무엇을 집을 수 있는지 화면에서 보여야 한다
- 포스트 프로세스 패스를 추가하지 않는다 — 패스는 그대로 프레임 비용이다
...
기존 아웃라인 머티리얼 한 패스 안에서 세피아 외곽선과 노란 포커스 링을 함께 그려, 패스 추가 없이 하이라이트를 얹었다.
