...
image: /assets/img/thumbs/cards/2026-06-10-algo-2026-06-10-1.svg
---
...
> **핵심 요약** — 드래그 거리를 최소화하는 영역은 모든 `#`의 min/max 행·열로 만든 최소 경계 사각형(bounding box)으로 바로 결정되며, 좌표가 칸이 아니라 격자점이라 끝점에 +1 보정이 필요하다.
{: .prompt-tip }
