...
image: /assets/img/thumbs/cards/2026-05-18-algo-2026-05-18-1.svg
---
...
> **핵심 요약** — 크기 k의 최소 힙을 유지하면 "상위 k개 중 최솟값"을 힙 top 한 번으로 꺼낼 수 있다. 매일 전체를 정렬할 필요 없이, k를 넘칠 때 최솟값만 pop하면 되므로 O(n log k)에 끝난다.
{: .prompt-tip }
