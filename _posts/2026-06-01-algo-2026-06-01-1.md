...
image: /assets/img/thumbs/cards/2026-06-01-algo-2026-06-01-1.svg
---
...
> **핵심 요약** — 아이와 쿠키를 둘 다 정렬한 뒤, 욕심이 가장 작은 아이에게 만족 가능한 가장 작은 쿠키를 배정하면 큰 쿠키가 아껴져 만족 인원이 최대가 된다. 정렬 + 투 포인터로 푸는 전형적인 그리디 매칭.
{: .prompt-tip }
