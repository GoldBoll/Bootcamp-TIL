...
image: /assets/img/thumbs/cards/2026-05-08-algo-2026-05-08-1.svg
---
...
> **핵심 요약** — 정렬 기준이 두 개일 때는 비교자 안에서 1차 키(n번째 글자)를 먼저 비교하고, 같을 때만 2차 키(문자열 전체 사전순)로 넘어가면 된다. `sort`에 람다 비교자를 넘겨 O(m log m)으로 해결.
{: .prompt-tip }
