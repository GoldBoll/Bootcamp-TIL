...
image: /assets/img/thumbs/cards/2026-06-08-algo-2026-06-08-1.svg
---
...
> **핵심 요약** — "4개를 빼면 위아래가 다시 붙는다"는 연쇄 조건이, 스택에서는 pop 후 다음 push가 자연스럽게 이전 재료 위에 이어지는 성질 덕분에 별도 재배치 없이 처리된다.
{: .prompt-tip }
