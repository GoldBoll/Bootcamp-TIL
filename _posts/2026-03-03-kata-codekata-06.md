...
> **오늘 배운 것** — 수열 전체를 훑지 않아도 앞 세 원소 비교만으로 등차/등비를 판별할 수 있고, "공비는 0이 아닌 정수"라는 제한사항이 정수 나눗셈을 안심하고 쓸 수 있는 근거가 된다. 제한사항이 곧 구현을 단순하게 만드는 힌트다.
{: .prompt-tip }

> **면접에서 이렇게 말한다** — 예상 질문: "등차수열과 등비수열을 코드로 어떻게 판별하나요?" → 인접 항의 차 비교, 공차/공비 정의, 제한사항 활용, 마지막 항에 공차 덧셈·공비 곱셈
{: .prompt-info }
