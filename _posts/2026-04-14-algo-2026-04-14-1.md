...
image: /assets/img/thumbs/cards/2026-04-14-algo-2026-04-14-1.svg
---
...
> **핵심 요약** — 직전 문자(prev)와 다를 때만 방문 배열을 검사하면, 어떤 문자가 연속 구간을 벗어났다가 다시 등장했는지를 한 번의 순회로 판별할 수 있다. bool[26] 배열은 int 하나에 비트마스크로 압축할 수도 있다.
{: .prompt-tip }
