...
image: /assets/img/thumbs/cards/2026-05-12-algo-2026-05-12-1.svg
---
...
> **핵심 요약** — "target이 삽입될 위치"는 곧 "target 이상인 첫 원소의 인덱스", 즉 lower_bound 그대로다. [left, right) 반열린 구간으로 짜면 값이 존재하는 경우와 없는 경우를 분기 없이 한 코드로 처리할 수 있다.
{: .prompt-tip }
