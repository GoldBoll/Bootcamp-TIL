...
image: /assets/img/thumbs/cards/2026-04-24-algo-2026-04-24-1.svg
---
...
> **핵심 요약** — 크기가 같은 두 행렬의 덧셈은 이중 루프로 같은 위치 원소를 더하면 끝난다. `answer`를 `arr1` 복사본으로 초기화하면 결과 행렬의 크기를 따로 잡을 필요가 없고, 시간 복잡도는 O(행×열)이다.
{: .prompt-tip }
