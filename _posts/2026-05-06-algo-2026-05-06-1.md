...
image: /assets/img/thumbs/cards/2026-05-06-algo-2026-05-06-1.svg
---
...
> **핵심 요약** — 거듭제곱을 O(n) 반복 대신 비트 단위 빠른 거듭제곱으로 O(log n)에 계산했다. 음수 지수는 역수로 바꿔 처리하되, n = INT_MIN이면 -n이 int 범위를 넘어가므로 long long으로 먼저 받아야 한다.
{: .prompt-tip }
