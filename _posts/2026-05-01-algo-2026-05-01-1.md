...
image: /assets/img/thumbs/cards/2026-05-01-algo-2026-05-01-1.svg
---
...
> **핵심 요약** — number 길이가 최대 13이라 세 수를 고르는 모든 조합을 삼중 루프로 확인해도 O(n³)이면 충분하다. `i < j < k`로 인덱스 순서를 고정하면 같은 조합이 두 번 세어지지 않는다.
{: .prompt-tip }
