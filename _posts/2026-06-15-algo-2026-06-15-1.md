...
image: /assets/img/thumbs/cards/2026-06-15-algo-2026-06-15-1.svg
---
...
> **핵심 요약** — 격자 이동 시뮬레이션은 목적지만 검사하면 틀린다. 한 칸씩 전진하며 중간 칸까지 전부 검사하고, 임시 좌표로 진행한 뒤 전 구간을 통과했을 때만 실제 좌표에 반영해야 실패 시 위치가 오염되지 않는다.
{: .prompt-tip }
